 ...
 class HomePage extends Component {
   ...
   async componentDidMount () {
     ...
     try {
       ...
       this.contentDataGroup = await RequestUtils.getContents(this.dateArray.slice(0, 10))
         ...
         <View style={styles.container}>
           <View style={styles.headerWrapper}>
             ...
             <View style={styles.editorWrapper}>
               <Text style={styles.imageEditors}>
                 {'via.' + homePageContent.福利[0].who}
               </Text>
             </View>
           </View>
           <View style={styles.contentWrapper}>
             <TouchableHighlight style={{flex: 2, marginTop: 17}}
               ...
               <View style={styles.content}>
                 <Text style={styles.videoTitle} numberOfLines={4}>
                   {homePageContent.休息视频[0].desc}
                 </Text>
                 <Text style={styles.dateAutor}>
                   {this.contentDataGroup[0].date + 'via.' + homePageContent.休息视频[0].who}
                 </Text>
                 <Text style={styles.toVideo}>
                   --> 去看视频~
                 </Text>
               </View>
